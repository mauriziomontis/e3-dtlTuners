#==============================================================================
# aliasPwrTunerStatus.cmd
#- Arguments: SLAVE_ID, HW_DESC, BIT_24V, BIT_48V, SECTION_NAME

#-d /**
#-d   \brief Alias Names for DTL Digital Status
#-d   \details Define the aliases for DTL digital bits devoted to Tuner Power status in order to align Records' Names to ESS Naming Convention.
...
#-d   \note Example call:
#-d   \code
#-d    ${SCRIPTEXEC} "${dtlTuner_DIR}aliasPwrTunerStatus.cmd", "SLAVE_ID=1, HW_DESC=EL1809, BIT_24V=3, BIT_48V=4, SECTION_NAME=DTL-010"
#-d   \endcode
#-d */
